...
<<<<<<< HEAD
This base class also implements some general utilities to interact with the lattice, such as $\texttt{is\_point\_inside()}$, that tells you if a point is inside the lattice space, and $\texttt{get\_ neighbors()}$, that gives the coordinates of the six neighbors (four in 2D) of a specific cell.\
...
>>>>>>> cc23558116ffbe1f3f729823ee8822f0088a5318
